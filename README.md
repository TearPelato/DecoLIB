...
# How to use?
This mod doesn't need to be installed, after the implementation(if you don't know how to add it the maven provide it [Maven](maven.liukrast.net/net/tearpelato/deco_lib)
